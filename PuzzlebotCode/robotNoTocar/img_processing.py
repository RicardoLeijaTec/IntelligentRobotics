...
def handler(data):
	...
	resize = cv.resize(res_green, (256,144)) # Image resizing
	...
	circles_green = cv.HoughCircles(cimg_green, cv.HOUGH_GRADIENT, 1, 20, param1=50, param2=30, minRadius=10, maxRadius=70)
	...
	resize_red = cv.resize(res_red, (256,144)) # Image resizing
	...
	circles_red = cv.HoughCircles(cimg_red, cv.HOUGH_GRADIENT, 1, 20, param1=50, param2=30, minRadius=10, maxRadius=70)
...
# Pruebas
# Buscar el sweet spot en el los valores del verde y del rojo, ver como mejorar el
# reconocimiento de circulos, diferentes valores de diametros, documentarme mas de 
# la funcion de hough circles, eliminar la recepcion del gui de calibracion una vez tenga
# todos los colores calibrados