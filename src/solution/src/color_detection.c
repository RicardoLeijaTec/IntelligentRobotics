...
#define __PYX_HAVE__color_detection
#define __PYX_HAVE_API__color_detection
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'color_detection' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static int __pyx_v_15color_detection_hue_range;
static int __pyx_v_15color_detection_s_min;
static int __pyx_v_15color_detection_v_min;
...
#define __Pyx_MODULE_NAME "color_detection"
extern int __pyx_module_is_main_color_detection;
int __pyx_module_is_main_color_detection = 0;

/* Implementation of 'color_detection' */
...
static const char __pyx_k_HUE_NEG[] = "HUE_NEG";
static const char __pyx_k_fortran[] = "fortran";
static const char __pyx_k_h_check[] = "h_check";
static const char __pyx_k_memview[] = "memview";
static const char __pyx_k_s_check[] = "s_check";
static const char __pyx_k_v_check[] = "v_check";
...
static const char __pyx_k_target_hue[] = "target_hue";
...
static const char __pyx_k_color_detection[] = "color_detection";
...
static PyObject *__pyx_n_s_HUE_NEG;
...
static PyObject *__pyx_n_s_color_detection;
static PyObject *__pyx_kp_s_color_detection_pyx;
...
static PyObject *__pyx_n_s_h_check;
...
static PyObject *__pyx_n_s_s_check;
...
static PyObject *__pyx_n_s_target_hue;
...
static PyObject *__pyx_n_s_v_check;
static PyObject *__pyx_n_s_width;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_15color_detection_in_range(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_frame, int __pyx_v_target_hue); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_15color_detection_1in_range(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_15color_detection_1in_range = {"in_range", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15color_detection_1in_range, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_15color_detection_1in_range(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_frame = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_target_hue;
  int __pyx_lineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_frame,&__pyx_n_s_target_hue,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_target_hue)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("in_range", 1, 2, 2, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "in_range") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_frame = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char__const__(values[0], 0); if (unlikely(!__pyx_v_frame.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_target_hue = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_target_hue == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("in_range", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("color_detection.in_range", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15color_detection_in_range(__pyx_self, __pyx_v_frame, __pyx_v_target_hue);
...
static PyObject *__pyx_pf_15color_detection_in_range(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_frame, int __pyx_v_target_hue) {
  int __pyx_v_height;
  int __pyx_v_width;
  unsigned char __pyx_v_h;
  ...
  PyObject *__pyx_v_h_check = NULL;
  PyObject *__pyx_v_s_check = NULL;
  PyObject *__pyx_v_v_check = NULL;
 ...
 * 
 */
  __pyx_v_HUE = ((int)(__pyx_v_target_hue * (180.0 / 360.0)));

  /* "color_detection.pyx":16
 * 
 *   cdef int HUE = int(target_hue * (180.0/360))
 *   cdef int HUE_NEG = HUE - 180             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_HUE_NEG = (__pyx_v_HUE - 0xB4);

  /* "color_detection.pyx":18
 *   cdef int HUE_NEG = HUE - 180
 * 
 *   height = frame.shape[0]             # <<<<<<<<<<<<<<
 *   width = frame.shape[1]
 * 
 */
  __pyx_v_height = (__pyx_v_frame.shape[0]);

  /* "color_detection.pyx":19
 * 
 *   height = frame.shape[0]
 *   width = frame.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_width = (__pyx_v_frame.shape[1]);

  /* "color_detection.pyx":21
 *   width = frame.shape[1]
 * 
 *   mask = np.zeros((height, width), np.ubyte)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_ubyte); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
      ...
      __pyx_t_15 = 0;
      __pyx_t_16 = (*((unsigned char const  *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_13 * __pyx_v_frame.strides[0]) ) + __pyx_t_14 * __pyx_v_frame.strides[1]) ) + __pyx_t_15 * __pyx_v_frame.strides[2]) )));
      __pyx_t_15 = __pyx_v_i;
      __pyx_t_14 = __pyx_v_j;
      __pyx_t_13 = 1;
      __pyx_t_17 = (*((unsigned char const  *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_15 * __pyx_v_frame.strides[0]) ) + __pyx_t_14 * __pyx_v_frame.strides[1]) ) + __pyx_t_13 * __pyx_v_frame.strides[2]) )));
      __pyx_t_13 = __pyx_v_i;
      __pyx_t_14 = __pyx_v_j;
      __pyx_t_15 = 2;
      __pyx_t_18 = (*((unsigned char const  *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame.data + __pyx_t_13 * __pyx_v_frame.strides[0]) ) + __pyx_t_14 * __pyx_v_frame.strides[1]) ) + __pyx_t_15 * __pyx_v_frame.strides[2]) )));
      __pyx_v_h = __pyx_t_16;
      __pyx_v_s = __pyx_t_17;
      __pyx_v_v = __pyx_t_18;

      /* "color_detection.pyx":27
 *     for j in range(width):
 *       h, s, v = frame[i][j][0], frame[i][j][1], frame[i][j][2]
 *       h_check = ((HUE - h) < hue_range) or ((h - HUE_NEG) < hue_range)             # <<<<<<<<<<<<<<
 *       s_check = s > s_min
 *       v_check = v > v_min
 */
      __pyx_t_19 = ((__pyx_v_HUE - __pyx_v_h) < __pyx_v_15color_detection_hue_range);
      if (!__pyx_t_19) {
      } else {
        __pyx_t_3 = __Pyx_PyBool_FromLong(__pyx_t_19); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_1 = __pyx_t_3;
        __pyx_t_3 = 0;
        goto __pyx_L7_bool_binop_done;
      }
      __pyx_t_19 = ((__pyx_v_h - __pyx_v_HUE_NEG) < __pyx_v_15color_detection_hue_range);
      __pyx_t_3 = __Pyx_PyBool_FromLong(__pyx_t_19); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_1 = __pyx_t_3;
      __pyx_t_3 = 0;
      __pyx_L7_bool_binop_done:;
      __Pyx_XDECREF_SET(__pyx_v_h_check, __pyx_t_1);
      __pyx_t_1 = 0;

      /* "color_detection.pyx":28
 *       h, s, v = frame[i][j][0], frame[i][j][1], frame[i][j][2]
 *       h_check = ((HUE - h) < hue_range) or ((h - HUE_NEG) < hue_range)
 *       s_check = s > s_min             # <<<<<<<<<<<<<<
 *       v_check = v > v_min
 ...
 */
      __pyx_t_1 = __Pyx_PyBool_FromLong((__pyx_v_s > __pyx_v_15color_detection_s_min)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_XDECREF_SET(__pyx_v_s_check, __pyx_t_1);
      __pyx_t_1 = 0;

      /* "color_detection.pyx":29
 *       h_check = ((HUE - h) < hue_range) or ((h - HUE_NEG) < hue_range)
 *       s_check = s > s_min
 *       v_check = v > v_min             # <<<<<<<<<<<<<<
 *       if(h_check and s_check and v_check):
 *         mask[i][j] = 255
 */
      __pyx_t_1 = __Pyx_PyBool_FromLong((__pyx_v_v > __pyx_v_15color_detection_v_min)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_XDECREF_SET(__pyx_v_v_check, __pyx_t_1);
      __pyx_t_1 = 0;

      /* "color_detection.pyx":30
 *       s_check = s > s_min
 *       v_check = v > v_min
 *       if(h_check and s_check and v_check):             # <<<<<<<<<<<<<<
 *         mask[i][j] = 255
 * 
 */
      __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_v_h_check); if (unlikely(__pyx_t_20 < 0)) __PYX_ERR(0, 30, __pyx_L1_error)
      if (__pyx_t_20) {
      } else {
        __pyx_t_19 = __pyx_t_20;
        goto __pyx_L10_bool_binop_done;
      }
      __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_v_s_check); if (unlikely(__pyx_t_20 < 0)) __PYX_ERR(0, 30, __pyx_L1_error)
      if (__pyx_t_20) {
      } else {
        __pyx_t_19 = __pyx_t_20;
        goto __pyx_L10_bool_binop_done;
      }
      __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_v_v_check); if (unlikely(__pyx_t_20 < 0)) __PYX_ERR(0, 30, __pyx_L1_error)
      __pyx_t_19 = __pyx_t_20;
      __pyx_L10_bool_binop_done:;
      if (__pyx_t_19) {

        /* "color_detection.pyx":31
 *       v_check = v > v_min
 *       if(h_check and s_check and v_check):
 *         mask[i][j] = 255             # <<<<<<<<<<<<<<
 * 
 *   return mask
 */
        __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_mask, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (unlikely(__Pyx_SetItemInt(__pyx_t_1, __pyx_v_j, __pyx_int_255, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 0, 0) < 0)) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_v_h_check);
  __Pyx_XDECREF(__pyx_v_s_check);
  __Pyx_XDECREF(__pyx_v_v_check);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "color_detection.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "color_detection._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_HUE_NEG, __pyx_k_HUE_NEG, sizeof(__pyx_k_HUE_NEG), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_color_detection, __pyx_k_color_detection, sizeof(__pyx_k_color_detection), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_h_check, __pyx_k_h_check, sizeof(__pyx_k_h_check), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_s_check, __pyx_k_s_check, sizeof(__pyx_k_s_check), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_target_hue, __pyx_k_target_hue, sizeof(__pyx_k_target_hue), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_v_check, __pyx_k_v_check, sizeof(__pyx_k_v_check), 0, 0, 1, 1},
 ...
 *   cdef unsigned char h, s, v
 */
  __pyx_tuple__19 = PyTuple_Pack(15, __pyx_n_s_frame, __pyx_n_s_target_hue, __pyx_n_s_height, __pyx_n_s_width, __pyx_n_s_h, __pyx_n_s_s, __pyx_n_s_v, __pyx_n_s_HUE, __pyx_n_s_HUE_NEG, __pyx_n_s_mask, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_h_check, __pyx_n_s_s_check, __pyx_n_s_v_check); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(2, 0, 15, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_color_detection_pyx, __pyx_n_s_in_range, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 11, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_color_detection) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "color_detection")) {
      if (unlikely(PyDict_SetItemString(modules, "color_detection", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  __pyx_v_15color_detection_hue_range = 8;

  /* "color_detection.pyx":6
 * cdef int hue_range = 8
 * 
 * cdef int s_min = (20*255)/360             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_15color_detection_s_min = 14;

  /* "color_detection.pyx":7
 * 
 * cdef int s_min = (20*255)/360
 * cdef int v_min = (50*255)/360             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
  __pyx_v_15color_detection_v_min = 35;
 ...
 *   cdef unsigned char h, s, v
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_15color_detection_1in_range, NULL, __pyx_n_s_color_detection); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_in_range, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init color_detection", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init color_detection");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
